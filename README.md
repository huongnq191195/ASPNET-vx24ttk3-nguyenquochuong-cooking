...
* **Sinh viên thực hiện:** Nguyễn Quốc Hương
* **Mã lớp:** VX24TTK3
...
## 1. Giới thiệu đề tài
Website **Chia sẻ công thức nấu ăn** là một nền tảng trực tuyến giúp kết nối những người yêu thích ẩm thực. Hệ thống cho phép người dùng tìm kiếm, học hỏi và chia sẻ các công thức nấu ăn ngon, đồng thời cung cấp công cụ quản trị cho Admin để kiểm soát nội dung.
...
* Xem danh sách công thức món ăn, tìm kiếm công thức theo từ khóa (tên món hoặc nguyên liệu).
...
* **Tìm kiếm công thức nâng cao**: Hỗ trợ tìm kiếm nhanh các món ăn theo tên hoặc từ khóa ngay tại giao diện quản lý.
* **Bộ lọc trạng thái bài đăng**: Lọc và phân loại danh sách món ăn theo trạng thái (Đã duyệt / Chờ kiểm duyệt) trực quan, đồng bộ với hệ thống phân trang.
* Thêm danh mục món ăn.
* Thêm, sửa, xóa các món ăn, bình luận.
